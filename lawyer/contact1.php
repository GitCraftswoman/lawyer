...
if (isset($_POST['submit']))
{
    ...
    //below eill be used for login
        $sql = "SELECT * FROM contact1 WHERE email='$email' ";
        ...
        {
            $sql = "INSERT INTO contact1 (username,email,Contact,Message)
			VALUES ('$username','$email','$Contact','$Message')";
            $result = mysqli_query($conn, $sql);
...
<form action="contact1.php" method="post">
  ...
  <div class="container">
    ...
    <button type="submit" class="btn btn-primary mr-3 d-none d-lg-block" name='submit'>Send Mesaage</button>
    <label>
