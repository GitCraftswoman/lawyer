...
if(isset($_POST['submit'])){
   ...
   $select_users = mysqli_query($conn, "SELECT * FROM `userclient` WHERE uname = '$username' AND password = '$password'") or die('query failed');

   if(mysqli_num_rows($select_users) > 0){
    
      $row = mysqli_fetch_assoc($select_users);
      
      if($row['user_type'] == 'uname'){
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="appointment.html" class="btn btn-primary mr-3 d-none d-lg-block">Get appointment</a>
                    </div>
                </nav>
            </div>
        </div>
...
<form action="login.php" method="post">
  ...
  <div class="container" style="background-color:#f1f1f1">
    ...
    <span class="psw">Forgot <a href="regester.php">password?</a></span>
  </div>
</form>
