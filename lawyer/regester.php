...
if (isset($_POST['submit']))
{
    ...
    //below eill be used for login
        $sql = "SELECT * FROM userclient WHERE email='$email' ";
        ...
        {
            $sql = "INSERT INTO userclient (username,email,password,cpassword)
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="appointment.html" class="btn btn-primary mr-3 d-none d-lg-block">Get appoint</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid bg-page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-3 text-white text-uppercase">Register As Client</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Register As Client</p>
                </div>
            </div>
        </div>
    </div>
...
<form action="regester.php" method="post">
  ...
  <div class="container">
    ...
    <button type="submit" class="btn btn-primary mr-3 d-none d-lg-block" name='submit'>Login</button>
    <label>
